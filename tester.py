                ...
                with inner_tqdm(total=len(data_iterator), leave=False, dynamic_ncols=True) as pbar:
                    ...
                    for batch_x, batch_y in data_iterator:
                        ...
                        with self.auto_cast():
                            ...
                            # seq = ""
                            # target_guize_all = []
                            # for i,o in zip(batch_x['words'].numpy(),pred_dict['pred'].numpy()):
                            #     for j in i:
                            #         seq += self.vocab.idx2word[j]
                            #     seq=seq.replace("<pad>",'')
                            ...
                            # # print("=========batchx===========")
                            # # print(pred_dict)
                            # # print(target_guize_all)
                            # pred_dict = dict()
                            # pred_dict['pred'] = target_guize_all
                            # # print(pred_dict)


                            pred_dict = guize(batch_x,pred_dict)
